...
class MainActivity : AppCompatActivity() {
    ...
    private fun showPlaylistSongOptions(song: Song) {
        ...
        // Set Ringtone
        view.findViewById<android.widget.TextView>(R.id.action_ringtone).setOnClickListener {
            setAsRingtone(song)
            dialog.dismiss()
        }
        
        // Share
        view.findViewById<android.widget.TextView>(R.id.action_share).setOnClickListener {
            shareSong(song)
            dialog.dismiss()
        }
        
        // Edit Info - NEW
        view.findViewById<android.widget.TextView>(R.id.action_edit_info).setOnClickListener {
